...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/07/27 20:05:32 by ychoucho          #+#    #+#             */
/*   Updated: 2026/07/28 01:05:25 by ychoucho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	add_to_queue(t_thread_data *coder, t_dongle *d)
{
	long	deadline1;
	long	deadline2;
	...
	{
		deadline1 = coder->sim->time_to_burnout
			+ d->queue[0].last_compilation_time;
		deadline2 = coder->sim->time_to_burnout
			+ d->queue[1].last_compilation_time;
